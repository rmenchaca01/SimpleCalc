...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mResultTextView = findViewById(R.id.operation_result_text_view); // Obtains reference to the result field
        mOperandOneEditText = findViewById(R.id.operand_one_edit_text);//Obtains reference to the operand field
